module Admin
  class TechnologiesController < Admin::HomeController
    ...
    def create
      ...
      if @technology.save
        ::TranslationWorker.perform_async(@technology.class, @technology.id, cookies[:lang])
    ...
    def update
      return add_translate(@technology, admin_technology_path(@technology)) if params[:translation]
